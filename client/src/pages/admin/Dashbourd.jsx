...
useEffect(() => {
  ...
  return  !loading ?(
    <>
    <Title text1="admin" text2="Dashbourd"/>
    <div className="relative flex flex-wrap gap-4 mt-6">
  <BlurCircle top="-100px" left="0" />
  <div className="flex  flex-wrap gap-4 w-full">
    {dashboardCards.map((card, index) => (
      <div key={index} className="flex items-center justify-between gap-12 px-4 py-3 bg-primary/10 border border-primary/20 rounded-md max-w-50 ">
        <div>
